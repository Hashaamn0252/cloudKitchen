...
class PsConfig {
  ...
  ///
  static const String ps_api_key = 'cloudkitchen';
  ...
  ///
  static const String ps_core_url = 'https://cloudkitchen.gulpapps.com';
  // 'https://www.products.panacea-soft.co/flutter-restaurant-admin-demo';
