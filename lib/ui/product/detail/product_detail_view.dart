          ...
          ChangeNotifierProvider<ProductDetailProvider>(
            ...
            create: (BuildContext context) {
              ...
              productDetailProvider!
                  .loadProduct(widget.productId!, loginUserId);
              ...
              builder: (BuildContext context, ProductDetailProvider provider,
                ...
                if (
                  ...
                  if (isCallFirstTime) {
                    ...
                    ///
                    historyProvider!
                        .addHistoryList(provider.productDetail.data!);
                        ...
                        return InkWell(
                          onTap: () {
                            ...
                            if (widget.selectedAddOnList[
                              ...
                              widget.selectedAddOnList[widget
                                  .productDetail.addOnList![index]] = true;
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> addToBasketAndBuyClickEvent(bool isBuyButtonType) async {
      ...
      if (isBuyButtonType) {
        ...
        if (result != null && result) {
          widget.productProvider.loadProduct(
              widget.product.id!, widget.psValueHolder.loginUserId!);
        }
      }
    }
